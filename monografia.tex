...
%==============================================================================
\author{Clésio Teixeira da Silva}
\title{Desenvolvimento de mudas de bananeira com diferentes adubações e condicionadores de solo}
\subtitle{\ }
\engtitle{Use of Uflamon Class}
\engsubtitle{Sample for Users}
%\edicao{3$^a$ edição revista, atualizada e ampliada}
\date{2023}
\tipo{Monografia apresentada à Universidade Federal de Lavras, como parta das exigências do Curso de Agronomia, para a obtenção do título de Bacharel.}
% use \orientador ou \orientadora quando for o caso
\orientador{Prof(a).\ Dr(a).\ Leila Aparecida Salles Pio}
%\orientadora{}
...
\local{Lavras --- MG}
\bancaum{Nome 1}{UFM}
\bancadois{Nome 2}{FCO} % comente se sua banca tiver só um professor
\bancatres{Nome 3}{BELMIS}
\bancaquatro{Nome 4}{IBGPLUS}
\defesa{30 de junho de 2023}
%==============================================================================
%##################################################
